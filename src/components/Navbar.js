    ...
    return (
        <nav className="flex justify-between items-center px-10 py-5 bg-white dark:bg-black text-black dark:text-white font-semibold uppercase tracking-wide">
            ...
            <div className="flex space-x-8 text-sm">
                <Link href="/verifyCV" className="hover:text-purple-600 dark:hover:text-purple-400 transition">
                    Verify Resume
                </Link>
                <Link href="/SubmitCV" className="hover:text-purple-600 dark:hover:text-purple-400 transition">
                    Submit Resume
                </Link>
                <Link href="/CertifyCV" className="hover:text-purple-600 dark:hover:text-purple-400 transition">
                    Certify Resume
                </Link>
            ...
            <div className="flex items-center space-x-4">
                ...
                <div
                    onClick={toggleTheme}
                    className="w-14 h-7 flex items-center bg-gray-300 dark:bg-gray-700 rounded-full p-1 cursor-pointer transition duration-300"
                >
                    <div
