    ...
    <>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-lg">Upload and register your professional experience on-chain</p>
        </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setResume({
                    ...resume,
                    experience: { ...resume.experience, organization: e.target.value },
                  })
                }
                className="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setResume({
                    ...resume,
                    experience: { ...resume.experience, title: e.target.value },
                  })
                }
                className="w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setResume({
                    ...resume,
                    experience: { ...resume.experience, details: e.target.value },
                  })
                }
