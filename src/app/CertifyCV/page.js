    ...
    <>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-lg">Certify verified experiences with your authorized account.</p>
        </div>
        ...
        {!account ? (
          ...
          <div className="mb-6 text-center">
            ...
            {!isCertifier && (
              <p className="text-red-600 mt-2">You are not authorized to certify experiences.</p>
            )}
          </div>
        )}
