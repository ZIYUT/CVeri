...
export default function Home() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center transition-colors duration-500
        ...
        >
            <div className="text-center px-6 py-12 max-w-3xl space-y-8">
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                    Empowering companies and individuals to verify professional experiences securely and transparently using{' '}
