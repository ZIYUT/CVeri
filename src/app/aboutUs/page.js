      ...
      <div className="space-y-16">
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            We believe in a world where verification of professional and educational achievements 
            is transparent, immutable, and accessible—eliminating fraud and streamlining the 
            hiring process.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Become a Certifier</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            We welcome organizations and institutions to join CVeri as authorized certifiers. 
            As a certifier, you'll have the ability to verify and authenticate professional 
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            launches officially. We appreciate your understanding regarding this temporary limitation.
          </p>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                <a href="https://www.linkedin.com/in/ziyu-tian-030b51139/" className="text-blue-600 dark:text-blue-400 hover:underline">linkedin.com/in/ziyu-tian-030b51139/</a>
              </p>
              <p className="text-gray-600 dark:text-gray-300">
                <span className="inline-block w-20">Email:</span> 
                <a href="mailto:tianziyu98@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">tianziyu98@gmail.com</a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                <span className="inline-block w-20">Email:</span> 
                <a href="mailto:dylanzhuo6@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">dylanzhuo6@gmail.com</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Open Source Project</h2>
          
          {/* Technology content moved here */}
          <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Technology</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            Our platform leverages the power of blockchain technology to create tamper-proof 
            records of professional experiences and academic achievements. By using smart contracts, 
            we ensure that once a credential is certified by an authorized institution, it cannot 
            be altered or falsified.
          </p>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Each resume entry is cryptographically hashed and stored on the blockchain, allowing 
            for secure and verifiable sharing of professional information.
          </p>
          
          <h3 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Project Access</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            CVeri is an open source project hosted on GitHub. We welcome contributions, feedback, and 
            suggestions for improving our software development.
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            please note that we maintain intellectual property rights to the codebase, and it may not 
            be used for commercial purposes without explicit permission.
          </p>
          
          {/* Added new paragraph about contact */}
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            If you have any questions about the project, or have constructive suggestions for 
            improvement, please don't hesitate to reach out using the contact information provided above. 
            We greatly welcome collaboration and feedback from the community.
          </p>
          
          <div className="mt-6 p-4 bg-gray-100 dark:bg-gray-700 rounded-md">
            <p className="text-gray-600 dark:text-gray-300 text-sm italic">
              © 2025 CVeri. All rights reserved. This project is licensed for non-commercial use only.
              For deployment questions or development suggestions, please contact our team.
            </p>
          </div>
        </div>
      </div>
